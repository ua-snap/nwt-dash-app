    ...
    <div class="container">
        <div class="columns">
            ...
            <div class="column content is-size-5">
                ...
                <p>Please contact <a href="mailto:uaf-snap-data-tools@alaska.edu">uaf-snap-data-tools@alaska.edu</a> if you have questions or would like to provide feedback for this tool.</p>
